...
{
    /// <summary>
    /// g-combobox — 對應 jEasyUI ComboBox（下拉選擇框）
    /// <g-combobox name="dept" label="部門" options="HR:人資,IT:資訊,OP:營運" value="IT"/>
    /// 或從靜態選項建立，或透過 api-url 動態載入
    /// </summary>
    ...
    public class GComboBoxTagHelper : TagHelper
    {
        ...
        public string ApiUrl      { get; set; } = "";   // 動態載入 API
    ...
    /// <summary>
    /// g-datebox — 對應 jEasyUI DateBox（日期選擇）
    /// <g-datebox name="startDate" label="開始日期" value="2024-01-01" required="true"/>
    ...
    /// <summary>
    /// g-numberbox — 對應 jEasyUI NumberBox（數字輸入框）
    /// <g-numberbox name="qty" label="數量" min="0" max="9999" step="1" precision="0"/>
    /// </summary>
    ...
    public class GNumberBoxTagHelper : TagHelper
    {
        ...
        public int    Precision   { get; set; } = 0;  // 小數位數
        public string Prefix      { get; set; } = "";  // 前置符號如 $
        public string Suffix      { get; set; } = "";  // 後置符號如 %
        public string AlpineModel { get; set; } = "";
        public bool   Required    { get; set; } = false;
        public bool   Disabled    { get; set; } = false;
        public int    ColSpan     { get; set; } = 1;
    ...
    /// <summary>
    /// g-number-spinner — 對應 jEasyUI NumberSpinner（帶加減按鈕的數字框）
    /// <g-number-spinner name="qty" label="數量" value="1" min="0" max="99"/>
    /// </summary>
