...
namespace Web_EIP_Csharp.Views.Components
{
    ...
    public class GCardViewTagHelper : TagHelper
    {
        ...
        public string EmptyText { get; set; } = "查無資料";
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var safeEmptyText = EmptyText ?? "查無資料";
            ...
            output.Content.SetHtmlContent($@"
                <div class=""px-4 py-3 border-b border-slate-200 bg-slate-50 flex items-center justify-between gap-3 flex-wrap"">
                    ...
                    <div class=""flex items-center gap-2 flex-wrap"">
                        ...
                        <div class=""flex items-center gap-1 {(ShowSorting ? "" : "hidden")}"" data-role=""sort-wrap"">
                            ...
                            <button type=""button"" data-role=""sort-dir"" class=""w-8 h-8 rounded-lg border border-slate-300 bg-white hover:bg-slate-100 text-slate-600"" title=""切換排序方向"">↕</button>
                        </div>
                    </div>
                </div>
                <div class=""p-4"">
                ...
                <div data-role=""pager-wrap"" class=""px-4 py-2 border-t border-slate-200 bg-slate-50/80 flex items-center justify-between gap-2 text-xs {(ShowPager ? "" : "hidden")}"">
                    <div class=""text-slate-500"">共 <span data-role=""total-count"" class=""font-semibold text-slate-700"">0</span> 筆</div>
                    <div class=""flex items-center gap-1"">
                        <button type=""button"" data-role=""prev"" class=""px-2 py-1 rounded border border-slate-300 bg-white hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed"">上一頁</button>
                        <span data-role=""page-info"" class=""px-2 text-slate-600"">1 / 1</span>
                        <button type=""button"" data-role=""next"" class=""px-2 py-1 rounded border border-slate-300 bg-white hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed"">下一頁</button>
                    </div>
                </div>
            ");
        }
