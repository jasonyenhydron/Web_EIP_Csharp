...
{
    /// <summary>
    /// g-page-header：各程式頁首列元件
    /// 包含漸層 icon、程式標題、公司副標、登入者資訊、今日日期。
    /// 使用方式：
    ...
    {
        /// <summary>頁面標題（h1）</summary>
        public string Title { get; set; } = string.Empty;

        /// <summary>副標（公司 / 系統名稱），預設：永勝光學 ERP / 系統</summary>
        public string Subtitle { get; set; } = "永勝光學 ERP / 系統";
        ...
        /// <summary>登入員工編號（如 A001）</summary>
        public string UserId { get; set; } = string.Empty;

        /// <summary>登入員工姓名</summary>
        public string UserName { get; set; } = string.Empty;

        /// <summary>今日日期（預設 DateTime.Now.ToString("yyyy-MM-dd")）</summary>
