 ...
 * 對應 jeasyui Tree — 靜態巢狀樹狀結構（Razor 資料源）
 *
 * 用法（靜態 Razor）：
 *   <g-tree id="programTree">
 *       <g-tree-node label="HRM 人資系統" icon="folder" expanded="true">
 *           <g-tree-leaf label="HRMGD47 請假申請" onclick="openProg('HRMGD47')" icon="file"/>
 *           <g-tree-leaf label="HRMGD01 打卡記錄" onclick="openProg('HRMGD01')"/>
 *       </g-tree-node>
 *       <g-tree-node label="IDM 系統管理">
 *           <g-tree-leaf label="IDMGD01 程式維護" onclick="openProg('IDMGD01')"/>
 *       </g-tree-node>
 *   </g-tree>
 *
 * 用法（動態 Razor foreach，搭配 Category 資料）：
 *   <g-tree>
...
namespace Web_EIP_Csharp.Views.Components
{
    ...
    public class GTreeNodeTagHelper : TagHelper
    {
        ...
        public string Badge    { get; set; } = "";        // 顯示 badge（如子項目數量）
        public string Onclick  { get; set; } = "";
