    ...
    public class GMenuItemTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext ctx, TagHelperOutput output)
        {
            ...
            var textColor = Type switch
            {
                ...
                _         => "text-slate-700 hover:bg-blue-50 hover:text-blue-700"
            };
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Content.SetHtmlContent($@"
                <input type=""checkbox"" id=""{inputId}"" name=""{Name}"" {chkAttr} {disAttr} {xmodel} {onChange}
                       class=""sr-only peer"">
                <div class=""relative w-11 h-6 bg-slate-200 peer-checked:bg-blue-500 rounded-full transition-colors duration-200 peer-focus:ring-2 peer-focus:ring-blue-300
