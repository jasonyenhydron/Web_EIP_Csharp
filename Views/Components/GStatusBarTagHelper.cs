...
{
    /// <summary>
    /// Status bar component for page messages and record information.
    /// Example:
    ...
    {
        /// <summary>Message input element id.</summary>
        public string MsgId { get; set; } = "statusBarMsg";

        /// <summary>Record indicator text, e.g. "1/1".</summary>
        public string RecordInfo { get; set; } = string.Empty;

        /// <summary>Default status message.</summary>
        public string DefaultMsg { get; set; } = "Ready.";

        /// <summary>Alpine expression for dynamic record info.</summary>
